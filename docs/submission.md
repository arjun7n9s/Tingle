...
| Chaos | **Discovery** | Hosted fixture in this repo (`fixtures/tingle-chaos/`) | `c_mt3jbbz21pal4p4vgp` |

Long-tail on purpose. A judge asking "why not the pre-built GitHub / Reddit /
Amazon / Product Hunt scraper?" gets: we didn't use those. Uneed and a DEV tag
listing are not in the maintained 800+ library we would be graded against.
