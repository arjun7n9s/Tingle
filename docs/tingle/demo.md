...
Matches [hackathon-fit.md](hackathon-fit.md) “Demo shape.” Five beats, in this
order. If beat 4 is missing, the demo does not fit the brief.
...
The judge-facing clone is [github.com/arjun7n9s/Tingle](https://github.com/arjun7n9s/Tingle).

---

## 1. Confirm the claim

Open Tingle (`npm run tingle:api` → http://127.0.0.1:8788, or `/tingle` in
web-ui). New project. Type a pitch, accept the one-sentence rewrite.
